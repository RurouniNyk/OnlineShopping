					...
					<div class="card">
						...
						<div class="container-fluid p-0 m-0">
							<div class="row text-center p-0 m-0">
								...
								<div class="col-md-6 item-bg mt-1">
									<a href="" class="text-decoration-none text-dark item-add addtocart data-id="data-id="<?= $item['id'] ?>">
										<i class="fas fa-cart-plus fa-lg item-add"></i>
									</a>
								</div>
							</div>
						</div>
